...
**`result/moscow_delivery.html`** — интерактивная карта с маршрутами, точками доставки и легендой. Каждый курьер — свой цвет. Клик по точке — адрес и время прибытия. Наведение на линию — суммарная статистика курьера.
